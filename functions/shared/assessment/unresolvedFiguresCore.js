 ...
 *
 * Part of the shared assessment package (see ./README.md): the React app and
 * the Cloud Functions export callable both import THIS file, so a paper refused
 * in the studio is refused by the server for the same reason, in the same
 * words. Environment-neutral by contract — no React, no DOM, no Firebase, no
 * `docx`, no browser exporter.
 *
