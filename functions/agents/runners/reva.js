...
const SYSTEM_PROMPT = [
  ...
  "never apply them. Cala has already checked the draft against the Zambian",
  "CBC knowledge base; her verdict (aligned, citations, gaps, drift) is in",
  "the user message below. Treat unresolved gaps or drift as serious",
  "pedagogical issues to flag in your edits. Your own focus is pedagogy,",
  "voice, age-appropriateness, inclusivity, and length.",
  "",
