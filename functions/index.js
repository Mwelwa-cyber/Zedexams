...
const {createRetryHandlers} = require("./agents/retryHandlers");
const {createNameBankHandlers} = require("./pictures/nameBankHandlers");
...
const quizVerifyHandlers = createQuizVerifyHandlers({
  onCall,
  HttpsError,
  anthropicApiKey,
  getUserRole,
...
exports.verifyQuiz = quizVerifyHandlers.verifyQuiz;
...
const nameBankHandlers = createNameBankHandlers({
  onCall,
  HttpsError,
  admin,
  anthropicApiKey,
...
exports.nameBankPictures = nameBankHandlers.nameBankPictures;
...
exports.retryAgentJob = retryHandlers.retryAgentJob;
