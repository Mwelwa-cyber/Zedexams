          ...
          {rows.map((row) => (
            <div className="vs-bankcard" key={row.id}>
              ...
              <div className="vs-bankcard__bar">
                ...
                <button type="button" className="vs-iconbtn" title="Use in Assessment Studio" aria-label="Use in Assessment Studio" onClick={() => reuseInAssessment(row)}><IconSend size={14} /></button>
