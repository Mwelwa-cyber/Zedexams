...
vi.mock('../../../engines/export-engine/schemeOfWorkToPdf',  () => ({ downloadSchemeOfWorkPdf:   vi.fn(async () => {}) }))
vi.mock('../../../engines/export-engine/sbaTaskToPdf',        () => ({ downloadSbaTaskPdf:        vi.fn(async () => {}) }))
...
vi.mock('../../../engines/export-engine/sbaTaskToDocx',       () => ({ downloadSbaTaskDocx:       vi.fn(async () => {}) }))
vi.mock('../../../engines/export-engine/sbaTrackerToDocx',    () => ({ downloadSbaTrackerDocx:    vi.fn(async () => {}) }))
vi.mock('../../../engines/export-engine/sbaPlannerToDocx',    () => ({ downloadSbaPlannerDocx:    vi.fn(async () => {}) }))
...
vi.mock('../../../shared/components/LessonActivitiesView',  () => ({ default: () => <div data-testid="la-view" /> }))
vi.mock('../../homework',          () => ({ HomeworkView: () => null }))
vi.mock('../components/AssessmentPaperView',   () => ({ default: () => null }))
vi.mock('../../../shared/components/FullLessonView',        () => ({ default: () => null }))
