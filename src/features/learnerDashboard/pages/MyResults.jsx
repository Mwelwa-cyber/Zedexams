...
import { BarChart3, CheckCircleIcon, ChevronRight, PencilLine, Search, Target, TrophyIcon, X } from '../../../components/ui/icons'
...
export default function MyResults() {
  ...
  return (
    <div className="max-w-2xl md:max-w-3xl mx-auto px-4 py-6 pb-28 lg:pb-8">
