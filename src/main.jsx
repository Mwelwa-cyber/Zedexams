...
// Service worker registration moved into <UpdatePrompt /> (mounted in
// App.jsx) so the same hook can both register the SW and drive the
// "new version available" UI. The Capacitor short-circuit happens
