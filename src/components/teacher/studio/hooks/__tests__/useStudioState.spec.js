...
// useStudioState now wires useSubtopicDetail to auto-load the curriculum row.
// Mock it here so this spec stays a pure state-logic test and never pulls the
// real curriculum service (→ firebase/config) into the module graph.
vi.mock('../useSubtopicDetail.js', () => ({
