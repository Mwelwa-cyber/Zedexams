...
const LEARNING_AREAS = [
  ...
  { emoji: '🔢', title: 'Pre-Mathematics & Science', body: 'Counting, sorting, patterns, shapes and exploring the natural world through hands-on discovery.', bg: '#e8f0ff', color: '#2d3a8c' },
