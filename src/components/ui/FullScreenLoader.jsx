  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        .zed-boot-glow { position: absolute; inset: -18%; border-radius: 50%; background: radial-gradient(circle, rgba(234, 88, 12, 0.22) 0%, rgba(234, 88, 12, 0) 68%); filter: blur(6px); animation: zed-boot-glow 2.8s ease-in-out infinite; }
        ...
        .zed-boot-stroke--orange { stroke: #EA580C; }
        .zed-boot-dot--blue { fill: #2563EB; }
        .zed-boot-dot--orange { fill: #EA580C; }
        ...
        .zed-boot-bar-fill { position: absolute; top: 0; left: 0; height: 100%; width: 40%; border-radius: 999px; background: linear-gradient(90deg, #2563EB, #EA580C); animation: zed-boot-bar 1.5s cubic-bezier(0.65, 0, 0.35, 1) infinite; }
