...
const credits = messageFromError({
  code: 'internal',
  message: 'Diagram redraw failed: OpenAI image request failed (429): rate limited',
})
assert.match(credits, /OpenAI image request failed \(429\): rate limited/, 'real reason is surfaced')
