...
export function buildHomeworkDocument(hw) {
  const children = []
...
export async function downloadHomeworkDocx(hw, filename = 'homework.docx') {
  const doc = buildHomeworkDocument(hw)
