...
// crisply), 'kie' = colour illustration for the few items where colour IS
// the content. Names are what teachers will search; keywords widen the
// match. Pure data module — node-testable.
