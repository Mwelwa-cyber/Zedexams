...
export const AGENTS = [
  ...
  },
  {
    ...
    outputs: '.auth-qa-report.json, .authoring-qa-report.json (local run outputs, gitignored since Phase 6) + summary job',
  ...
  },
  {
    ...
    outputs: 'Review notes back to the caller',
    wraps: '.claude/agents/code-reviewer.md',
    runtime: ['subagent'],
    invocation: 'On demand: invoke the code-reviewer subagent with a diff. The per-PR GitHub Action was removed — it billed the API on every push while duplicating checks that required CI already enforces deterministically.',
  },
  {
    id: 'ledger',
    name: 'Ledger',
    ...
    invocation: 'Cron: daily 22:00 Africa/Lusaka (agent-release-notes.yml), plus workflow_dispatch. Manually: invoke the release-notes subagent.',
  },
  {
    id: 'mendi',
    name: 'Mendi',
