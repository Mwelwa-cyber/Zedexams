...
import StudioGate from '../guards/StudioGate'
import { questionBankRedirectPath } from '../../shared/utils/questionBankDeepLink'

const TeacherDashboard = lazy(() => import('../../features/teacherHome/pages/TeacherDashboard'))
...
const WelcomeToPro = lazy(() => import('../../features/teacherHome/pages/WelcomeToPro'))
...
const SchoolCalendar = lazy(() => import('../../features/teacherHome/pages/SchoolCalendar'))
const SyllabiLibrary = lazy(() => import('../../features/teacherHome/pages/SyllabiLibrary'))
const CurriculumHome = lazy(() => import('../../features/curriculumBrowsers/pages/CurriculumHome'))
const ECECurriculum = lazy(() => import('../../features/curriculumBrowsers/pages/ECECurriculum'))
const PrimaryCurriculum = lazy(() => import('../../features/curriculumBrowsers/pages/PrimaryCurriculum'))
const SecondaryCurriculum = lazy(() => import('../../features/curriculumBrowsers/pages/SecondaryCurriculum'))
const Curriculum2013Home = lazy(() => import('../../features/curriculumBrowsers/pages/Curriculum2013Home'))
const ECE2013Curriculum = lazy(() => import('../../features/curriculumBrowsers/pages/ECE2013Curriculum'))
