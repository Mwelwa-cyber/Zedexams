...
export const SAMPLE_LESSON_PLANS = [
  ...
  /* ═══════════════════════════════════════════════════════════════
   *  Grade 7 Integrated Science — Electricity: Simple Circuits
   * ═══════════════════════════════════════════════════════════════ */
  {
    slug: 'grade-7-integrated-science-electricity',
    seo: {
      title: 'Grade 7 Integrated Science Lesson Plan — Simple Electric Circuits | Zambian CBC',
      description: 'Free Zambian CBC lesson plan for Grade 7 Integrated Science on Simple Electric Circuits. CDC-format with Specific Outcomes, Key Competencies, Values, practical activities and Assessment. ECZ Composite Exam aligned.',
    },
    meta: {
      grade: 'G7',
      subject: 'integrated_science',
      topic: 'Electricity',
      subtopic: 'Simple Circuits',
    },
    plan: {
      schemaVersion: '1.0',
      header: {
        ...
        topic: 'Electricity',
        subtopic: 'Simple Circuits',
        termAndWeek: 'Term 2, Week 6',
        numberOfPupils: 38,
        mediumOfInstruction: 'English',
      },
      specificOutcomes: [
        'By the end of the lesson, pupils should be able to identify the four main components of a simple circuit (cell, wire, bulb, switch).',
        'By the end of the lesson, pupils should be able to connect a working simple circuit using the materials provided.',
        'By the end of the lesson, pupils should be able to explain why a bulb does not light in a broken circuit.',
      ],
      keyCompetencies: [
        'Scientific literacy',
      ...
      values: ['Safety', 'Curiosity', 'Cooperation'],
      prerequisiteKnowledge: [
        'Pupils know that electricity is a form of energy.',
        'Pupils know that some materials (metals) conduct electricity and others (plastic, wood) do not.',
        'Pupils can work in groups and follow safety instructions.',
      ],
      teachingLearningMaterials: [
        '1.5V dry cells (8)',
        'Small torch bulbs with holders (8)',
        'Insulated copper wires, 20 cm each (24)',
        'Simple on/off switches or paper-clip switches (8)',
        'Chalkboard and chalk',
        "Grade 7 Integrated Science Pupil's Book (CDC), pages 88–92",
      ],
      references: [
        { title: "Zambia Grade 7 Integrated Science Pupil's Book", publisher: 'CDC', pages: '88–92' },
        { title: "Grade 7 Science Teacher's Guide", publisher: 'CDC', pages: '45' },
      ],
      lessonDevelopment: {
        introduction: {
          durationMinutes: 5,
          teacherActivities: [
            'Greets pupils and settles the class.',
            'Shows a torch and turns it on. Asks: "What makes the bulb light up?"',
            'Writes today\'s topic on the board: "Simple Circuits".',
          ],
          pupilActivities: [
            'Greet the teacher.',
            'Observe the torch and share ideas about how it works.',
            'Copy the topic into their exercise books.',
          ],
        },
        development: [
          {
            stepNumber: 1,
            title: 'Introducing circuit components',
            durationMinutes: 10,
            teacherActivities: [
              'Holds up each component (cell, wire, bulb, switch) and names it.',
              'Draws the standard symbols for each on the board and explains that a diagram uses symbols, not pictures.',
              'Emphasises safety: pupils must never connect both ends of a wire to the same cell without a bulb — it heats the wire.',
            ],
            pupilActivities: [
              'Identify each component as the teacher holds it up.',
              'Copy the circuit symbols into their exercise books.',
              'Listen carefully to the safety instructions and acknowledge them.',
            ],
          },
          {
            stepNumber: 2,
            title: 'Group practical — build a simple circuit',
            durationMinutes: 17,
            teacherActivities: [
              'Divides the class into 8 groups of 4–5 pupils. Distributes one set of materials per group.',
              'Demonstrates safely: one cell + two wires + one bulb in a holder. Bulb lights.',
              'Instructs groups to (a) light their bulb, then (b) add a switch, then (c) show what happens when a wire is disconnected.',
              'Walks between groups, asking questions: "What is the path of electricity? What stops it?"',
            ],
            pupilActivities: [
              'Form groups and collect materials responsibly.',
              'Work together to light their bulb. Every pupil takes a turn connecting a component.',
              'Add a switch and test it.',
              'Observe what happens when a wire is disconnected and note it down.',
            ],
          },
          {
            stepNumber: 3,
            title: 'Drawing the circuit diagram',
            durationMinutes: 5,
            teacherActivities: [
              'Calls the class back to attention.',
              'Draws a labelled diagram of a simple circuit on the board using standard symbols.',
              'Asks pupils to copy it and label each component in their books.',
            ],
            pupilActivities: [
              'Return materials to the teacher.',
              'Copy the circuit diagram carefully into their exercise books.',
              'Label each component (cell, wire, bulb, switch).',
            ],
          },
        ],
        conclusion: {
          durationMinutes: 3,
          teacherActivities: [
            'Asks 2 pupils: "Why did the bulb stop lighting when you disconnected the wire?"',
            'Summarises: a circuit must be a complete loop for electricity to flow.',
            'Previews tomorrow\'s lesson: conductors and insulators.',
          ],
          pupilActivities: [
            'Answer the teacher\'s question using the word "complete" or "loop".',
      ...
      assessment: {
        formative: [
          'Observation during the group practical — did every pupil take a turn?',
          'Checking the labelled circuit diagrams in each pupil\'s book.',
          'Oral questioning during the conclusion.',
        ],
        summative: {
          description: 'Each pupil draws a simple circuit diagram with correct symbols and labels all four components, in their exercise book.',
          successCriteria: 'A pupil has met the outcome if they draw all four components with correct symbols and the circuit forms a complete loop.',
        },
      },
      differentiation: {
        forStruggling: [
          'Allocate to groups with a stronger peer who can guide the connection.',
          'Provide a pre-drawn circuit template to trace.',
        ],
        forAdvanced: [
          'Challenge them to build a circuit with two bulbs in series and observe the brightness.',
          'Ask them to explain why the bulbs are dimmer than one bulb alone.',
        ],
      },
      homework: {
        description: 'Draw one real electrical appliance in your home (torch, radio, phone charger) as a simple circuit diagram, labelling the cell, wire, bulb/device, and switch.',
        estimatedMinutes: 20,
      },
      teacherReflection: {
        whatWentWell: '',
