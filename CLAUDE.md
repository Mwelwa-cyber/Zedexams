...
src/
  ...
  components/
    ...
    (games/ MIGRATED 2026-08-14 → src/features/games/ — see below. One file remains: a re-export shim for the frozen QuizList)
