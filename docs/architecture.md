...
| ~~`register` — re-inventory first~~ · ~~inventory DONE 2026-08-10, migration split in two and unclaimed~~ · **CLAIMED 2026-08-11 by session D**, branch `claude/phase-4-feature-migration-rlqnw2` — **ONE pull request, not two; the split was withdrawn, see the correction below** | ~~`dashboardV2`~~ → **reassigned to C** | ~~`dashboardV2`~~ — **not a pure move, see below** |
