...
census. Not deleted here: a removal is not a migration, the same call
`GenerateFromTopicMenu` got one section up. It belongs in
`docs/architecture/22-dead-code-register.md`.
