...
### Added
- Admin panel now shows actionable agent alignment status with clear indicators. (#583)

### Fixed
- CALA agent alignment checks now properly validate CBC compliance requirements. (#583)
